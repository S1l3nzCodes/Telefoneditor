...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8("test.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(_fromUtf8("lupe.ico")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
#Funktionen
        ...
        def run():
            ...
            if self.RNeu.isChecked():
                ...
                cursor.close()
                conn.close()
                self.ESuche.setText(str(self.EName_3.text()))
                suche()
