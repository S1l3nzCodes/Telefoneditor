...
#
# Created: Tue Feb 04 21:05:54 2014 by Florian Becker
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.LAuthor.setStyleSheet(_fromUtf8("background-color:#BFBFBF"))
        ...
        self.LDatum.setStyleSheet(_fromUtf8("background-color:#BFBFBF"))
        ...
        self.gridLayout_4.addWidget(self.BDel, 0, 4, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.BQuit, 1, 4, 1, 1)
        ...
        self.pushButton.setStyleSheet(_fromUtf8("background-color:#EFC58B"))
        ...
        self.gridLayout_4.addWidget(self.BUpdate, 1, 3, 1, 1)
        self.BClear = QtGui.QPushButton(self.centralWidget)
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Verdana"))
        font.setPointSize(12)
        self.BClear.setFont(font)
        self.BClear.setStyleSheet(_fromUtf8("background-color:#A3C08B"))
        self.BClear.setObjectName(_fromUtf8("BClear"))
        self.gridLayout_4.addWidget(self.BClear, 0, 2, 1, 2)
        ...
        self.tableWidget.setHorizontalHeaderLabels(['Name', 'Info', 'Nummer', 'Fax', 'Author', 'Datum', 'Key','Sichtbar'])
        ...
        self.label.setStyleSheet(_fromUtf8("background-color:#6D87CE"))
        ...
        def suche():
            ...
            self.label.setText("suche in Datenbank...")
            ...
            self.label.setText("Datenbank wurde durchsucht.")
            cursor.close()
            conn.close()
        ...
        def insert():
            ...
            cursor.close()
            conn.close()
            result = str(Name)+(" :")+str(Info)+(" :")+str(Nummer)
            Result=("Neue Daten eingegeben: "+result)
        ...
        def update():
            ...
            cursor.close()
            result = str(Name)+(" :")+str(Info)+(" :")+str(Nummer)
            Result=("Daten wurden angepasst: "+result)
            self.label.setText(Result)
            conn.close()
        ...
        def delete():
            ...
            for i in cursor:
                A=0
                for j in rows:
                    self.LName.setText(j[0])
                    self.LInfo.setText(j[1])
                    self.LNummer.setText(j[2])
            ...
            conn.close()
            #result = str(Name)+(" :")+str(Info)+(" :")+str(Nummer)
            #Result=("Daten wurden entfernt: "+result)
            #self.label.setText(Result)
            suche()

        self.tableWidget.cellClicked.connect(clicked)
        self.retranslateUi(MainWindow)
        QtCore.QObject.connect(self.pushButton, QtCore.SIGNAL(_fromUtf8("clicked()")), self.LName.clear)
        QtCore.QObject.connect(self.pushButton, QtCore.SIGNAL(_fromUtf8("clicked()")), self.LInfo.clear)
        QtCore.QObject.connect(self.pushButton, QtCore.SIGNAL(_fromUtf8("clicked()")), self.LNummer.clear)
        QtCore.QObject.connect(self.pushButton, QtCore.SIGNAL(_fromUtf8("clicked()")), self.LFax.clear)
        ...
        QtCore.QObject.connect(self.BClear, QtCore.SIGNAL(_fromUtf8("clicked()")), insert)

        QtCore.QMetaObject.connectSlotsByName(MainWindow)
        MainWindow.setTabOrder(self.tableWidget, self.LName)
        MainWindow.setTabOrder(self.LName, self.LInfo)
        MainWindow.setTabOrder(self.LInfo, self.LNummer)
        MainWindow.setTabOrder(self.LNummer, self.LFax)
        MainWindow.setTabOrder(self.LFax, self.BClear)
        MainWindow.setTabOrder(self.BClear, self.BDel)
        MainWindow.setTabOrder(self.BDel, self.BUpdate)
        MainWindow.setTabOrder(self.BUpdate, self.BQuit)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.LAuthor.setText(_translate("MainWindow", "Author", None))
        self.LDatum.setText(_translate("MainWindow", "Datum", None))
        self.BDel.setText(_translate("MainWindow", "Eintrag löschen", None))
        self.BQuit.setText(_translate("MainWindow", "Schließen", None))
        self.BSuche.setText(_translate("MainWindow", "Namen suchen", None))
        self.pushButton.setText(_translate("MainWindow", "Eingabe löschen", None))
        self.BUpdate.setText(_translate("MainWindow", "Eintrag bearbeiten", None))
        self.BClear.setText(_translate("MainWindow", "Neue Daten eingeben", None))
        self.label.setText(_translate("MainWindow", "letzte  durchgeführte Aktion: ...", None))
